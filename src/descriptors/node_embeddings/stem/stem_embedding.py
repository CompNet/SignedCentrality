...
class StEMEmbedding(GraphDescriptor):
	...
	def perform_csv(file=GENERATED_INPUT_DATA, **kwargs):
		...
		batch_size = math.ceil(0.4 * len(triples)) # I switched from 'int()' to 'ceil()'
		#print("batch_size", batch_size)
		batch_size0 = math.ceil(0.4 * len(triples0)) # I switched from 'int()' to 'ceil()'
		#print("len(triples0)", len(triples0))
		#print("batch_size0", batch_size0)

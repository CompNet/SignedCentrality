...
"""
This package contains an altered version of SiNE implementation for the paper "Signed Network Embedding in SocialMedia" writen by S. Wang, J. Tang, C. Aggarwal, Y. Chang and H. Liu.

...
class SiNE(nn.Module):
    def __init__(self, num_nodes, dim1, dim2):
        ...
        self.z11 = None                                         # Added code.
        self.z12 = None                                         # Added code.
    ...
    def forward(self, xi, xj, xk, delta):
        ...
        self.z11 = z11                                          # Added code.
        self.z12 = z12                                          # Added code.
    ...
    def get_x(self):                                        # Added code.
        return self.get_edge_feature(self.z11, self.z12)    # Added code.
